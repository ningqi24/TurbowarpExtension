        ...
        getInfo() {
            ...
            return {
                ...
                blocks: [
                    ...
                    { opcode: 'whenKeyString', blockType: B.HAT, text: '当按下[KEY_OPTION]键', arguments: { KEY_OPTION: { type: A.STRING, defaultValue: 'enter' } }, category: '工具集' },
                    { opcode: 'keyStringPressed', blockType: B.BOOLEAN, text: '按下[KEY_OPTION]键?', arguments: { KEY_OPTION: { type: A.STRING, defaultValue: 'enter' } }, category: '工具集' },
                    { opcode: 'alertBlock', blockType: B.COMMAND, text: '弹出提示[STRING]', arguments: { STRING: { type: A.STRING, defaultValue: '即将加载！' } }, category: '工具集' },
                    { opcode: 'confirmationBlock', blockType: B.BOOLEAN, text: '弹出确认框[STRING]', arguments: { STRING: { type: A.STRING, defaultValue: '是否加载？' } }, category: '工具集' },
                    { opcode: 'inputPromptBlock', blockType: B.REPORTER, text: '弹出输入框[PROMPT] 默认值 [DEFAULT]', arguments: { PROMPT: { type: A.STRING, defaultValue: '请输入内容' }, DEFAULT: { type: A.STRING, defaultValue: '默认文本' } }, category: '工具集' },
                    { opcode: 'isPackaged', blockType: B.REPORTER, text: '是打包作品？', category: '工具集' },
                    { opcode: 'returnCount', blockType: B.REPORTER, text: '计数器', arguments: {}, category: '工具集' },
                    { opcode: 'incrementCountByNum', blockType: B.COMMAND, text: '将计数器增加[NUM]', arguments: { NUM: { type: A.NUMBER, defaultValue: 1 } }, category: '工具集' },
                    { opcode: 'decrementCountByNum', blockType: B.COMMAND, text: '将计数器减少[NUM]', arguments: { NUM: { type: A.NUMBER, defaultValue: 1 } }, category: '工具集' },
                    { opcode: 'setCount', blockType: B.COMMAND, text: '将计数器设为[NUM]', arguments: { NUM: { type: A.NUMBER, defaultValue: 0 } }, category: '工具集' },
                    { opcode: 'stringNotEqual', blockType: B.BOOLEAN, text: '[TEXT1]≠[TEXT2]', arguments: { TEXT1: { type: A.STRING, defaultValue: 'hi' }, TEXT2: { type: A.STRING, defaultValue: 'hi2' } }, category: '工具集' },
                    { opcode: 'whenTrueFalse', blockType: B.HAT, text: '当 [CONDITION] 变为 [STATE] ', isEdgeActivated: true, arguments: { CONDITION: { type: A.BOOLEAN }, STATE: { type: A.STRING, menu: 'boolean' } }, category: '工具集' },
                    { opcode: 'whileTrueFalse', blockType: B.HAT, text: '只要 [CONDITION] 为 [STATE]', isEdgeActivated: false, arguments: { CONDITION: { type: A.BOOLEAN }, STATE: { type: A.STRING, menu: 'boolean' } }, category: '工具集' },
                    { opcode: 'broadcastData', blockType: B.COMMAND, text: '广播 [BROADCAST_OPTION] 并携带数据 [DATA]', arguments: { BROADCAST_OPTION: { type: null }, DATA: { type: A.STRING, defaultValue: '' } }, hideFromPalette: true, category: '工具集' },
                    { opcode: 'broadcastDataAndWait', blockType: B.COMMAND, text: '广播 [BROADCAST_OPTION] 并携带数据 [DATA] 并等待', arguments: { BROADCAST_OPTION: { type: null }, DATA: { type: A.STRING, defaultValue: '' } }, hideFromPalette: true, category: '工具集' },
                    ...
                    { opcode: 'receivedData', blockType: B.REPORTER, text: '收到的数据', disableMonitor: true, allowDropAnywhere: true, category: '工具集' },
                    '---',
                    { opcode: 'labelCondition', blockType: B.LABEL, text: '条件交互 × mini', category: '工具集' },
                    { opcode: 'getMilliseconds', blockType: B.REPORTER, text: '获取当前毫秒数', arguments: {}, category: '工具集' },
                    { opcode: 'startCountdown', blockType: B.COMMAND, text: '从[seconds]秒开始倒计时', arguments: { seconds: { type: A.NUMBER, defaultValue: 10 } }, category: '工具集' },
                    { opcode: 'getCountdown', blockType: B.REPORTER, text: '获取倒计时剩余秒数', arguments: {}, category: '工具集' },
                    { opcode: 'getTimezone', blockType: B.REPORTER, text: '获取当前时区', arguments: {}, category: '工具集' },
                    { opcode: 'getScreenWidth', blockType: B.REPORTER, text: '获取屏幕宽度', arguments: {}, category: '工具集' },
                    { opcode: 'getScreenHeight', blockType: B.REPORTER, text: '获取屏幕高度', arguments: {}, category: '工具集' },
                    { opcode: 'getVolumeLevel', blockType: B.REPORTER, text: '获取音量级别', arguments: {}, category: '工具集' },
                    { opcode: 'vibrate', blockType: B.COMMAND, text: '震动[milliseconds]毫秒', arguments: { milliseconds: { type: A.NUMBER, defaultValue: 500 } }, category: '工具集' },
                    { opcode: 'copyToClipboardSystem', blockType: B.COMMAND, text: '复制文本[text]到剪贴板', arguments: { text: { type: A.STRING, defaultValue: 'Hello Scratch!' } }, category: '工具集' },
                    { opcode: 'readFromClipboard', blockType: B.REPORTER, text: '从剪贴板读取文本', arguments: {}, category: '工具集' },
                    { opcode: 'openLink', blockType: B.COMMAND, text: '打开浏览器网址:[url]', arguments: { url: { type: A.STRING, defaultValue: '' } }, category: '工具集' },
                    '---',
                    { opcode: 'labelString', blockType: B.LABEL, text: '字符串处理 × TW-A', category: '工具集' },
                    { opcode: 'lettersToOf', blockType: B.REPORTER, text: '[STRING]的第[INPUTA]到第[INPUTB]个字符', arguments: { INPUTA: { type: A.NUMBER, defaultValue: '1' }, INPUTB: { type: A.NUMBER, defaultValue: '3' }, STRING: { type: A.STRING, defaultValue: '114514' } }, category: '工具集' },
                    { opcode: 'newlineCharacter', blockType: B.REPORTER, text: '换行符', category: '工具集' },
                    { opcode: 'stringIfElse', blockType: B.REPORTER, text: '如果[BOOLEAN]则[INPUTA]否则[INPUTB]', arguments: { BOOLEAN: { type: A.BOOLEAN, defaultValue: '' }, INPUTA: { type: A.STRING, defaultValue: '1' }, INPUTB: { type: A.STRING, defaultValue: '0' } }, category: '工具集' },
                    { opcode: 'encodeText', blockType: B.REPORTER, text: '编码[TEXT]为数字', arguments: { TEXT: { type: A.STRING, defaultValue: 'Hi' } }, category: '工具集' },
                    { opcode: 'decodeText', blockType: B.REPORTER, text: '解码[TEXT]为字符串', arguments: { TEXT: { type: A.STRING, defaultValue: '114514' } }, category: '工具集' },
                    { opcode: 'md5Hash', blockType: B.REPORTER, text: 'MD5hash[TEXT]', arguments: { TEXT: { type: A.STRING, defaultValue: 'Hi' } }, category: '工具集' },
                    { opcode: 'color', blockType: B.REPORTER, text: '[COLOR]的代码', arguments: { COLOR: { type: A.COLOR, defaultValue: '#29a9ff' } }, category: '工具集' },
                    { opcode: 'brightnessByColor', blockType: B.REPORTER, text: '[color]的亮度', arguments: { color: { type: A.COLOR, defaultValue: '#29a9ff' } }, category: '工具集' },
                    { opcode: 'repeatTxtTimes', blockType: B.REPORTER, text: '重复文字[TEXT][NUM]次', arguments: { TEXT: { type: A.STRING, defaultValue: 'Hi' }, NUM: { type: A.NUMBER, defaultValue: 2 } }, category: '工具集' },
                    { opcode: 'jsonParse', blockType: B.REPORTER, text: '解析JSON[TEXT]', arguments: { TEXT: { type: A.STRING, defaultValue: '"Hi"' } }, category: '工具集' },
                    { opcode: 'json_vm_getlist', blockType: B.REPORTER, text: '获取列表[list]', arguments: { list: { type: A.STRING, menu: 'get_list' } }, category: '工具集' },
                    { opcode: 'json_vm_setlist', blockType: B.COMMAND, text: '将[list]设为[json]', arguments: { list: { type: A.STRING, menu: 'get_list' }, json: { type: A.STRING, defaultValue: '["Hi","hi"]' } }, category: '工具集' },
                    '---',
                    { opcode: 'labelString', blockType: B.LABEL, text: '字符串处理 × mini', category: '工具集' },
                    { opcode: 'split', blockType: B.REPORTER, text: '将文本[text]按[delimiter]分割', arguments: { text: { type: A.STRING, defaultValue: 'hello world' }, delimiter: { type: A.STRING, defaultValue: ' ' } }, category: '工具集' },
                    { opcode: 'replace', blockType: B.REPORTER, text: '将文本[text]中的[old]替换为[new]', arguments: { text: { type: A.STRING, defaultValue: 'hello world' }, old: { type: A.STRING, defaultValue: 'world' }, new: { type: A.STRING, defaultValue: 'Scratch' } }, category: '工具集' },
                    { opcode: 'find', blockType: B.REPORTER, text: '在文本[searchText]中查找[text]', arguments: { text: { type: A.STRING, defaultValue: 'world' }, searchText: { type: A.STRING, defaultValue: 'hello world' } }, category: '工具集' },
                    { opcode: 'removeSpaces', blockType: B.REPORTER, text: '移除文本[text]中的空格', arguments: { text: { type: A.STRING, defaultValue: 'hello world' } }, category: '工具集' },
                    { opcode: 'toUppercase', blockType: B.REPORTER, text: '将文本[text]转为大写', arguments: { text: { type: A.STRING, defaultValue: 'hello' } }, category: '工具集' },
                    { opcode: 'toLowercase', blockType: B.REPORTER, text: '将文本[text]转为小写', arguments: { text: { type: A.STRING, defaultValue: 'HELLO' } }, category: '工具集' },
                    { opcode: 'characterCount', blockType: B.REPORTER, text: '文本[text]的字符数', arguments: { text: { type: A.STRING, defaultValue: 'hello' } }, category: '工具集' },
                    { opcode: 'reverse', blockType: B.REPORTER, text: '反转文本[text]', arguments: { text: { type: A.STRING, defaultValue: 'hello' } }, category: '工具集' },
                    { opcode: 'deduplicate', blockType: B.REPORTER, text: '对列表[list]去重', arguments: { list: { type: A.STRING, defaultValue: '1,2,3,2,1' } }, category: '工具集' },
                    { opcode: 'sort', blockType: B.REPORTER, text: '对列表[list]排序', arguments: { list: { type: A.STRING, defaultValue: '3,1,4,1,5' } }, category: '工具集' },
                    { opcode: 'randomFromList', blockType: B.REPORTER, text: '从列表[list]中随机选择', arguments: { list: { type: A.STRING, defaultValue: 'apple,banana,orange' } }, category: '工具集' },
                    { opcode: 'findPosition', blockType: B.REPORTER, text: '在列表[list]中查找[item]的位置', arguments: { item: { type: A.STRING, defaultValue: 'banana' }, list: { type: A.STRING, defaultValue: 'apple,banana,orange' } }, category: '工具集' },
                    { opcode: 'mergeLists', blockType: B.REPORTER, text: '合并列表[list1]和[list2]', arguments: { list1: { type: A.STRING, defaultValue: '1,2,3' }, list2: { type: A.STRING, defaultValue: '4,5,6' } }, category: '工具集' },
                    { opcode: 'sliceList', blockType: B.REPORTER, text: '从列表[list]中截取从[start]到[end]的部分', arguments: { list: { type: A.STRING, defaultValue: '1,2,3,4,5' }, start: { type: A.NUMBER, defaultValue: 1 }, end: { type: A.NUMBER, defaultValue: 3 } }, category: '工具集' },
                    { opcode: 'copyToClipboard', blockType: B.COMMAND, text: '复制文本[text]到剪贴板', arguments: { text: { type: A.STRING, defaultValue: 'Hello Scratch!' } }, category: '工具集' },
                    { opcode: 'readFromLocalTxt', blockType: B.REPORTER, text: '从本地读取.txt文件', arguments: {}, category: '工具集' },
                    { opcode: 'convertToCase', blockType: B.REPORTER, text: '将文本[text]转换为[case]', arguments: { text: { type: A.STRING, defaultValue: 'hello' }, case: { type: A.STRING, menu: 'textCase', defaultValue: 'lowercase' } }, category: '工具集' },
                    { opcode: 'isCase', blockType: B.BOOLEAN, text: '文本[text]是否为[case]', arguments: { text: { type: A.STRING, defaultValue: 'hello' }, case: { type: A.STRING, menu: 'textCase', defaultValue: 'lowercase' } }, category: '工具集' },
                    { opcode: 'unicodeOf', blockType: B.REPORTER, text: '字符[char]的Unicode编码', arguments: { char: { type: A.STRING, defaultValue: 'A' } }, category: '工具集' },
                    { opcode: 'characterFromUnicode', blockType: B.REPORTER, text: 'Unicode编码[code]对应的字符', arguments: { code: { type: A.NUMBER, defaultValue: 65 } }, category: '工具集' },
                    { opcode: 'countCharacters', blockType: B.REPORTER, text: '文本[text]中[char]的数量', arguments: { text: { type: A.STRING, defaultValue: 'apple' }, char: { type: A.STRING, defaultValue: 'p' } }, category: '工具集' },
                    { opcode: 'startsWith', blockType: B.BOOLEAN, text: '文本[text]是否以[prefix]开头', arguments: { text: { type: A.STRING, defaultValue: 'turbowarp' }, prefix: { type: A.STRING, defaultValue: 'turbo' } }, category: '工具集' },
                    { opcode: 'endsWith', blockType: B.BOOLEAN, text: '文本[text]是否以[suffix]结尾', arguments: { text: { type: A.STRING, defaultValue: 'turbowarp' }, suffix: { type: A.STRING, defaultValue: 'warp' } }, category: '工具集' },
                    '---',
                    { opcode: 'labelCloud', blockType: B.LABEL, blockIconURI: NC_ICON,  text: '10000why的云变量V2 × mini', category: '工具集' },
                    { opcode: 'connect', blockType: B.COMMAND, text: '连接云服 [SERVER]', arguments: { SERVER: { type: A.STRING, defaultValue: 'wss://clouddata.turbowarp.org' } }, category: '工具集' },
                    { opcode: 'disconnect', blockType: B.COMMAND, text: '断开云服', category: '工具集' },
                    { opcode: 'status', blockType: B.REPORTER, text: '连接状态', category: '工具集' },
                    { opcode: 'version', blockType: B.REPORTER, text: '协议版本', category: '工具集' },
                    { opcode: 'getLatency', blockType: B.REPORTER, text: ' [SERVER] 的延迟', arguments: { SERVER: { type: A.STRING, defaultValue: 'wss://clouddata.turbowarp.org' } }, category: '工具集' },
                    { opcode: 'createVar', blockType: B.COMMAND, text: '创建云变量 [NAME]', arguments: { NAME: { type: A.STRING, defaultValue: 'SChat' } }, category: '工具集' },
                    { opcode: 'deleteVar', blockType: B.COMMAND, text: '删除云变量 [NAME]', arguments: { NAME: { type: A.STRING, menu: 'varNames' } }, category: '工具集' },
                    { opcode: 'setVar', blockType: B.COMMAND, text: '将 [NAME] 设为 [VAL]', arguments: { NAME: { type: A.STRING, menu: 'varNames' }, VAL: { type: A.STRING, defaultValue: '123' } }, category: '工具集' },
                    { opcode: 'changeVar', blockType: B.COMMAND, text: '将 [NAME] 增加 [DELTA]', arguments: { NAME: { type: A.STRING, menu: 'varNames' }, DELTA: { type: A.NUMBER, defaultValue: 1 } }, category: '工具集' },
                    { opcode: 'getVar', blockType: B.REPORTER, text: '读取 [NAME]', arguments: { NAME: { type: A.STRING, menu: 'varNames' } }, category: '工具集' },
                    { opcode: 'onUpdated', blockType: B.HAT, isEdgeActivated: true, text: '当 [NAME] 更新', arguments: { NAME: { type: A.STRING, menu: 'varNames' } }, category: '工具集' },
                    '---',
                    { opcode: 'labelAsset', blockType: B.LABEL, blockIconURI: NC_ICON,  text: '文件与资源管理 × TW-A', category: '工具集' },
                    { opcode: 'addSprite', blockType: B.COMMAND, text: '从URL [URL] 加载角色', arguments: { URL: { type: A.STRING, defaultValue: '' } }, category: '工具集' },
                    { opcode: 'addCostume', blockType: B.COMMAND, text: '从URL [URL] 加载造型 [NAME]', arguments: { URL: { type: A.STRING, defaultValue: '' }, NAME: { type: A.STRING, defaultValue: '造型1' } }, category: '工具集' },
                    { opcode: 'deleteSprite', blockType: B.COMMAND, text: '删除角色 [TARGET]', arguments: { TARGET: { type: A.STRING, menu: 'targets' } }, category: '工具集' },
                    { opcode: 'deleteCostume', blockType: B.COMMAND, text: '删除造型 [COSTUME]', arguments: { COSTUME: { type: A.STRING, defaultValue: '造型1' } }, category: '工具集' },
                    { opcode: 'deleteImage', blockType: B.COMMAND, text: '删除角色[SPRITE]的造型[COSNAME]', arguments: { COSNAME: { type: A.STRING, defaultValue: '造型1' }, SPRITE: { type: A.STRING, defaultValue: '角色1' } }, category: '工具集' },
                    { opcode: 'getAllSprites', blockType: B.REPORTER, text: '所有角色', category: '工具集' },
                    { opcode: 'getAllCostumes', blockType: B.REPORTER, text: '所有造型', category: '工具集' },
                    { opcode: 'getAllSounds', blockType: B.REPORTER, text: '所有声音', category: '工具集' },
                    { opcode: 'getSpriteName', blockType: B.REPORTER, text: '角色名字', category: '工具集' },
                    { opcode: 'showPickerAs', blockType: B.REPORTER, text: "打开文件作为 [as] ", arguments: { as: { type: A.STRING, menu: 'encoding' } }, category: '工具集' },
                    { opcode: 'showPickerExtensionsAs', blockType: B.REPORTER, text: "打开 [extension] 作为 [as] ", arguments: { extension: { type: A.STRING, defaultValue: ".txt" }, as: { type: A.STRING, menu: 'encoding' } }, category: '工具集' },
                    { opcode: 'download', blockType: B.COMMAND, text: "下载 [text] 为 [file]", arguments: { text: { type: A.STRING, defaultValue: "你好！" }, file: { type: A.STRING, defaultValue: "保存.txt" } }, category: '工具集' },
                    { opcode: 'downloadURL', blockType: B.COMMAND, text: "将 URL [url] 下载为 [file]", arguments: { url: { type: A.STRING, defaultValue: "" }, file: { type: A.STRING, defaultValue: "保存2.txt" } }, category: '工具集' },
                    { opcode: 'setOpenMode', blockType: B.COMMAND, text: "设置打开方式 [mode]", arguments: { mode: { type: A.STRING, defaultValue: MODE_MODAL, menu: "automaticallyOpen" } }, category: '工具集' },
                    { opcode: 'clonesBeingUsed', blockType: B.REPORTER, text: '克隆体数量', category: '工具集' },
                    { opcode: 'isClone', blockType: B.BOOLEAN, text: '是克隆体?', category: '工具集' },
                    { opcode: 'getfps', blockType: B.REPORTER, text: '帧率', arguments: {}, category: '工具集' },
                    '---',
                    { opcode: 'labelCondition', blockType: B.LABEL, text: 'Full version for new ningqiCollection:', category: '工具集' },
                    { opcode: 'openCollection', blockType: B.COMMAND, text: 'OpenURL[url]', arguments: { url: { type: A.STRING, defaultValue: 'https://github.com/ningqi24/Scratch-Turbowarp-more-Extension' } }, category: '工具集' },
